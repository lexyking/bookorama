...
const handleAddBook = async (e) => {
  ...
  if (titleOfTheBook.value) {
    // addForm.submit();
    const params = { book: addBookInput.value };
    // let res = await axios.post("/books", params);
    // console.log(res.data);
    // const li = document.createElement("li");
    // const deleteSpan = document.createElement("span");
    // li.setAttribute("class", "bookItem");
    // deleteSpan.setAttribute("class", "btn deleteBtn");
    // li.innerHTML = titleOfTheBook.value;
...
const handleDelete = (e) => {
  ...
  listOfBooks.removeChild(elementToDelete);
};
